...
class GuardiansControllerTest < ActionController::TestCase
  ...
  test "should create guardian" do
    assert_difference('Guardian.count') do
      post :create, guardian: { email: @guardian.email, name: @guardian.name, password_digest: @guardian.password_digest, student_id: @guardian.student_id }
    end
  ...
  test "should update guardian" do
    patch :update, id: @guardian, guardian: { email: @guardian.email, name: @guardian.name, password_digest: @guardian.password_digest, student_id: @guardian.student_id }
    assert_redirected_to guardian_path(assigns(:guardian))
  end
